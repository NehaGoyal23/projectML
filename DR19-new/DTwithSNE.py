# -*- coding: utf-8 -*-
"""
Created on Mon Jul 22 02:49:44 2019
...
data1= pd.read_csv('Gear1SSNE30.csv', header=None)
...
X_train, X_test, y_train, y_test = train_test_split(X_dataset, y_data, test_size=0.2)
